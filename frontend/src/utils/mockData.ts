  ...
  'backend-developer': [
    {
      icon: '💻',
      title: 'Základy programování',
      description: 'Nauč se programovat v Pythonu nebo Node.js. Pochop algoritmy, datové struktury a objektově orientované programování.',
    },
    {
      icon: '🗄️',
      title: 'Databáze a SQL',
      description: 'Zvládni práci s databázemi - SQL, PostgreSQL, MongoDB. Nauč se navrhovat efektivní databázové schéma.',
    },
    {
      icon: '🌐',
      title: 'REST API a GraphQL',
      description: 'Vytváření API endpointů, autentizace, autorizace. Pochop REST principy a moderní API architektury.',
    },
    {
      icon: '🔒',
      title: 'Bezpečnost a optimalizace',
      description: 'Naučte se zajišťovat aplikace, pracovat s cache, optimalizovat výkon a škálovat systémy.',
    },
    {
      icon: '☁️',
      title: 'Cloud a deployment',
      description: 'Práce s cloudem (AWS, Azure), CI/CD, Docker, Kubernetes. Deployování produkčních aplikací.',
    },
  ],
};
