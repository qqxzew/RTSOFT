...
export const onboardingQuestions: Question[] = [
  ...
  {
    id: 8,
    aiMessage: "Skvělé! Jaké máš oblíbené aktivity? Vyber všechny, které tě baví:",
    promptPrefix: "",
    type: 'choice',
    choices: ['Sport a pohyb', 'Kreslení a umění', 'Programování', 'Hudba', 'Psaní a literatura', 'Věda a experimenty'],
    category: 'interests',
  },
  {
    id: 9,
    ...
    promptPrefix: "",
    type: 'choice',
    choices: ['Videem a vizuálně', 'Čtením textů', 'Praxí a zkoušením', 'Diskuzí s ostatními'],
  ...
  },
  {
    ...
    promptPrefix: "",
    type: 'choice',
    choices: ['Ráno - jsem ranní ptáče', 'Odpoledne - po škole', 'Večer - mám klid', 'Kdykoli - není to důležité'],
    category: 'preferences',
  },
  {
    id: 16,
    ...
    promptPrefix: "",
    type: 'choice',
    choices: ['Raději sám/sama', 'V malé skupině', 'Ve velkém týmu', 'Záleží na situaci'],
    category: 'preferences',
  },
  {
    id: 17,
  ...
  },
  {
    ...
    promptPrefix: "",
    type: 'choice',
    choices: ['Méně než hodinu', '1-2 hodiny', '2-3 hodiny', 'Více než 3 hodiny'],
    category: 'preferences',
  },
  {
    id: 20,
    ...
    promptPrefix: "",
    type: 'choice',
    choices: ['Kreativita', 'Logické myšlení', 'Komunikace', 'Organizace', 'Trpělivost', 'Rychlé učení'],
    category: 'skills',
  },
  {
    id: 21,
  ...
  },
  {
    ...
    promptPrefix: "",
    type: 'choice',
    choices: ['Kvalita výuky', 'Blízkost k domovu', 'Zaměření školy', 'Přátelé/spolužáci', 'Budoucí kariéra'],
    category: 'goals',
  },
  {
    id: 24,
    ...
    promptPrefix: "",
    type: 'choice',
    choices: ['Nadšený/á a jistý/á', 'Optimistický/á ale nejistý/á', 'Trochu nervózní', 'Nevím co čekat'],
    category: 'preferences',
  },
  {
    id: 25,
