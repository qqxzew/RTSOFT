...
export const Onboarding = () => {
  ...
  const questions = [
    {
      key: "name",
      prompt: "Napiš prosím: Ahoj, já jsem …",
    ...
    },
    {
      ...
      validation: (val: string) =>
        /^\d+$/.test(val) && parseInt(val) >= 12 && parseInt(val) <= 18,
    },
    {
      key: "interests",
      prompt: "Co tě baví? Co ti jde?",
    ...
    if (currentStep === 0) {
      setTimeout(() => {
        setConversation((prev) => [
          ...prev,
          { id: 1, question: questions[0].prompt },
        ]);
        setCurrentStep(1);
        setShowInput(true);
      }, 800);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (currentStep < questions.length) {
      setTimeout(() => {
        setConversation((prev) => [
          ...prev,
          { id: currentStep + 1, question: questions[currentStep].prompt },
        ]);
  ...
  return (
    <div className="min-h-screen relative overflow-hidden flex items-center justify-center p-4 md:p-8">
      ...
      <div className="relative z-10 w-full max-w-4xl">
        ...
        <GlassCard
          className="p-6 md:p-12 min-h-[600px] flex flex-col"
          hover={false}
        >
          <div
                    ...
                    <div className="flex-1 pt-2">
                      {index === 0 || item.id > currentStep - 1 ? (
                        <TypingText
                          ...
                          speed={30}
                          onComplete={
                            index === 0 ? handleTypingComplete : undefined
                          }
