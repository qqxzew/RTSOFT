        ...
        <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-gray-50 via-white to-[#86BC25]/10">
            ...
            <div className="relative z-10 flex items-center justify-center min-h-screen px-4 py-12">
                ...
                >
                    ...
                    {/* Auth Card */}
                    <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 0.3 }} className="relative group">
                        {/* Glow effect */}
                        ...
                        <div className="relative bg-white/80 backdrop-blur-2xl border-2 border-gray-200/50 rounded-3xl p-8 shadow-2xl">
                            <div className="space-y-6">
                                ...
                                <AnimatePresence>
                                    {error && (
                                        <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} className="p-3 bg-red-50 border border-red-200 rounded-xl">
                                ...
                                {/* Info text */}
                                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.5 }} className="mt-4 p-4 bg-gray-50/50 border border-gray-200 rounded-xl">
