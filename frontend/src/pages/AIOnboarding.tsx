...
export const AIOnboarding = () => {
  ...
  const handleSubmit = (e?: React.FormEvent) => {
    ...
    if (currentQuestion.type === 'choice' && selectedChoices.length === 0) return;
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-gray-50 via-white to-gray-100">
        ...
        >
          <div className="flex items-center justify-between p-4 bg-white/90 backdrop-blur-2xl border-2 border-gray-200/80 rounded-2xl shadow-xl">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-xl font-bold text-gray-900 flex items-center gap-2" style={{ fontFamily: 'Montserrat, sans-serif' }}>
                  AI Průvodce
            ...
            <div className="flex items-center gap-3">
              <div className="hidden sm:flex flex-col items-end">
                <span className="text-xs text-gray-500 font-medium" style={{ fontFamily: 'Montserrat, sans-serif' }}>
                  Dokončeno
                </span>
                <span className="text-2xl font-bold bg-gradient-to-r from-[#86BC25] to-[#6a9c1d] bg-clip-text text-transparent" style={{ fontFamily: 'Montserrat, sans-serif' }}>
                  {Math.round(progress)}%
                </span>
              </div>
              ...
              <div className="w-16 h-16 relative">
                <svg className="w-16 h-16 transform -rotate-90">
                  ...
                  <motion.circle
                    ...
                    animate={{ strokeDasharray: `${(progress / 100) * 175.93} 175.93` }}
              ...
              <motion.div className="flex gap-4 items-start">
                ...
                <div className="flex-1 max-w-[80%]">
                  <div className="bg-white/90 backdrop-blur-xl border-2 border-gray-200 rounded-2xl rounded-tl-none p-4 shadow-xl">
                    <p className="text-gray-800 font-medium text-sm leading-relaxed" style={{ fontFamily: 'Montserrat, sans-serif' }}>
              ...
              <motion.div className="flex gap-4 items-start justify-end">
                <div className="flex-1 max-w-[80%] flex justify-end">
                  <div className="bg-gradient-to-br from-[#86BC25] to-[#6a9c1d] rounded-2xl rounded-tr-none p-4 shadow-xl">
                    <p className="text-white font-medium leading-relaxed" style={{ fontFamily: 'Montserrat, sans-serif' }}>
          ...
          <AnimatePresence mode="wait">
            ...
            {showQuestion && (
              ...
              >
                ...
                <div className="flex-1 max-w-[85%]">
                  <motion.div 
                    className="relative group bg-white/90 backdrop-blur-xl border-2 border-gray-200 rounded-2xl rounded-tl-none p-6 shadow-2xl overflow-hidden"
                  >
                    ...
                    <p className="relative text-gray-900 font-semibold text-lg leading-relaxed" style={{ fontFamily: 'Montserrat, sans-serif' }}>
                      {displayedText}
                      <motion.span
                        animate={{ opacity: [1, 0] }}
            ...
            {currentQuestion.type === 'text' ? (
                  ...
                  <div className="relative flex items-center gap-3 bg-white backdrop-blur-xl border-2 border-gray-200 rounded-3xl p-2 shadow-2xl">
                    ...
                    <div className="flex-1 flex items-center gap-3 px-4 py-3">
                      ...
                      <div className="flex-1 flex items-center gap-2">
                        <span className="text-gray-600 font-semibold text-sm whitespace-nowrap" style={{ fontFamily: 'Montserrat, sans-serif' }}>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {currentQuestion.choices?.map((choice, index) => (
                    ...
                    >
                      ...
                      <motion.div
                        animate={{
                          opacity: selectedChoices.includes(choice) ? [0.3, 0.5, 0.3] : 0,
                        }}
                        transition={{ duration: 2, repeat: Infinity }}
                      ...
                      >
                        ...
                        <div className="relative flex items-center justify-between gap-3">
                          ...
                          <motion.div
                            animate={{
                              scale: selectedChoices.includes(choice) ? [1, 1.2, 1] : 1,
                              rotate: selectedChoices.includes(choice) ? [0, 360] : 0,
                            }}
                            transition={{ duration: 0.5 }}
                          >
                            {selectedChoices.includes(choice) ? (
                ...
                <motion.button
                  ...
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ delay: (currentQuestion.choices?.length || 0) * 0.08 + 0.2 }}
      ...
      {currentQuestionIndex === totalQuestions - 1 && responses.length === totalQuestions && (
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          ...
          >
            ...
            <div className="relative bg-white/95 backdrop-blur-2xl border-2 border-gray-200 rounded-3xl p-10 shadow-2xl text-center overflow-hidden">
              ...
              <motion.div
                ...
                style={{
                  background: "linear-gradient(90deg, #86BC25, #d0d0d0, #86BC25)",
              ...
              <motion.p
                ...
                style={{ fontFamily: 'Montserrat, sans-serif' }}
              >
                Tvoje odpovědi nám pomohou připravit personalizovaný plán pro tvoji budoucnost...
              </motion.p>
