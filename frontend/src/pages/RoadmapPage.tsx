...
import { ArrowRight, Check, Lock, Sparkles, BookOpen, Code, Briefcase, GraduationCap, Target, Zap } from 'lucide-react';
...
export const RoadmapPage = () => {
  ...
  const getRoadmapForCareer = (career: string): RoadmapNode[] => {
    ...
    if (career.toLowerCase().includes('software') || career.toLowerCase().includes('it') || career.toLowerCase().includes('programov')) {
      return [
        {
          id: 'basics',
