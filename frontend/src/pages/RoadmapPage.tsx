...
export const RoadmapPage = () => {
  ...
  useEffect(() => {
    // Check if user came from career reveal
  ...
  const getRoadmapForCareer = (career: string): RoadmapNode[] => {
    // Tech/Software Developer roadmap
    if (
      ...
      return [
        ...
        },
        {
          ...
          resources: ["React dokumentace", "TypeScript Handbook"],
        },
        {
          id: "backend",
          ...
          estimatedTime: "3-4 měsíce",
          resources: ["Node.js docs", "PostgreSQL tutoriály"],
        },
        {
          id: "databases",
          title: "Databáze & ORM",
    ...
    if (
      ...
      career.toLowerCase().includes("grafick")
    ) {
      return [
        {
          id: "design-basics",
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {careerTemplates.map((career, index) => (
                ...
                >
                  ...
                  <h3
                    className="text-xl font-bold text-gray-900 group-hover:text-gray-900 transition-colors"
                    style={{ fontFamily: "Montserrat, sans-serif" }}
                  >
                    {career.title}
                  </h3>
        ...
        {isGenerating && (
          ...
          >
            <motion.div
              ...
              className="w-16 h-16 border-4 border-gray-300 border-t-gray-900 rounded-full mb-6"
            />
            <p
          ...
          >
            ...
            <div className="space-y-6">
              {roadmapNodes.map((node, index) => {
                ...
                const isLocked =
                  index > 0 && !completedNodes.has(roadmapNodes[index - 1].id);
                ...
                return (
                  ...
                  >
                    ...
                    {index < roadmapNodes.length - 1 && (
                      <div className="absolute left-12 top-full w-0.5 h-6 bg-gray-300 z-0" />
                    )}
                    ...
                    >
                      <div className="flex items-start gap-6">
                        {/* Icon */}
                        <div
                          className={`flex-shrink-0 w-16 h-16 rounded-2xl bg-gradient-to-br ${getCategoryColor(node.category)} flex items-center justify-center text-white relative`}
                        >
                          {isLocked ? (
