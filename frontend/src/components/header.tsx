import { Bubbles, House, LayoutDashboard, Video, LogOut, User, Map } from "lucide-react";
            ...
            <div className="max-w-7xl mx-auto px-8 py-4">
                <div className="flex items-center justify-between">
                    ...
                    >
                        ...
                        />
                        <h1 className="text-2xl font-black text-black tracking-tight" style={{ fontFamily: 'Montserrat, sans-serif' }}>
                            Školník
                        </h1>
                    </motion.a>
                    ...
                    <nav className="hidden md:flex items-center gap-1">
                        ...
                        <MenuItem label="Přehled" href="/prehled" icon={<LayoutDashboard size={17} />} />
                        <MenuItem label="Roadmap" href="/roadmap" icon={<Map size={17} />} />
                        <MenuItem label="AI Chat" href="/chat" icon={<Bubbles size={17} />} />
                        <MenuItem label="3D Chat" href="/chat3d" icon={<Video size={17} />} />
                    </nav>
...
const MenuItem:React.FC<{label:string, href:string, icon: React.ReactNode}> = ({label, href, icon}) => {
    return (
        <motion.a 
            href={href}
        ...
        >
            <motion.span 
              className="absolute bottom-0 left-0 w-0 h-1 bg-gradient-to-r from-[#86BC25] to-[#6a9c1d] group-hover:w-full transition-all duration-300 rounded-full"
            />
            <motion.span
